...
public class NdfdXMLLocator extends org.apache.axis.client.Service implements gov.oldWeather.NdfdXML {
 ...
 */
    ...
    public gov.oldWeather.NdfdXMLPortType getndfdXMLPort() throws javax.xml.rpc.ServiceException {
    ...
    public gov.oldWeather.NdfdXMLPortType getndfdXMLPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            gov.oldWeather.NdfdXMLBindingStub _stub = new gov.oldWeather.NdfdXMLBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (gov.oldWeather.NdfdXMLPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                gov.oldWeather.NdfdXMLBindingStub _stub = new gov.oldWeather.NdfdXMLBindingStub(new java.net.URL(ndfdXMLPort_address), this);
                _stub.setPortName(getndfdXMLPortWSDDServiceName());
                return _stub;
            }
        }
